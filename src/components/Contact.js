        ...
        <div className="contact-details-container slide-in-right delay-400">
          ...
          <ul className="contact-info-list">
            ...
            <li className="contact-info-item">
              ...
              <a href="https://www.linkedin.com/in/shobhit-verma-549744231?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer">
                LinkedIn Profile
              </a>
            </li>
          </ul>
